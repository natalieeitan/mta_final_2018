                                ...
                                <div class="container">
                                    ...
                                    <div class="row justify-content-around text-right">
                                        <div class="row text-right">
                                            ...
                                            <div>
                                                <label class="radio-btn col-md-6">
                                                    <input type="radio" name="weAreCouple" value="false">
                                                    אני ספק</label>
                                            </div>
                                    ...
                                    <div class="row justify-content-around text-right">
                                        ...
                                        <label class="input mb-10">
                                            <input type="text" name="contactName" style="font-weight: normal" required>
                                        </label>
                                    </div>
                                    <div class="row justify-content-around text-right">
                                        <label class="col-md-5 ">טלפון*</label>
                                        <label class="input mb-10">
                                            <input type="text" name="contactPhone" style="font-weight: normal" required>
                                        </label>
                                    </div>
                                    <div class="row justify-content-around text-right">
                                        <label class="col-md-5 ">אימייל*</label>
                                        <label class="input mb-10">
                                            <input type="text" name="contactEmail" style="font-weight: normal" required>
                                        </label>
                                    </div>
                                    <div class="row justify-content-around text-right">
                    ...
                    <div class="col-md-5 col-sm-5">
                        <div style="width:95%">
                            ...
                            <label class="wow fadeInUp" data-wow-delay="0.3s" style="font-size: 18px">
                                ...
                                <br>בשביל זה אנחנו כאן.
                                אנחנו ב- Perfect Match פותחים עבורכם ערוץ נוסף למציאת זוגות לחתונה ומפנים אליכם
